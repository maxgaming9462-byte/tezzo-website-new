...
export const RideReminderBanner: React.FC<RideReminderBannerProps> = ({
  ...
  return (
    <div className="fixed top-4 right-4 left-4 sm:left-auto sm:max-w-md z-50 animate-in slide-in-from-top-5 fade-in duration-300">
      <div className="bg-[var(--color-on-surface)] text-white p-4 rounded-2xl shadow-2xl border border-[var(--color-primary)] flex flex-col gap-3 relative overflow-hidden">
        {/* Top accent bar */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[var(--color-primary)] via-[var(--color-accent-mint)] to-[var(--color-primary-container)]" />

        <div className="flex items-start justify-between gap-3 pt-1">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[var(--color-primary)] text-[var(--color-accent-mint)] flex items-center justify-center shrink-0 shadow-xs">
              <Bell className="w-5 h-5 animate-bounce" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-extrabold uppercase tracking-wider bg-[var(--color-primary)] text-[var(--color-accent-mint)] px-2 py-0.5 rounded-md">
                  1-Hour Ride Alert
                </span>
        ...
        <div className="bg-[#2a2a2a] p-3 rounded-xl border border-white/10 text-xs flex flex-col gap-2">
          <div className="flex items-center justify-between font-bold text-gray-200">
            ...
            <span className="text-[var(--color-accent-mint)] text-[11px] font-extrabold">
              {payload.date}
            </span>
          </div>

          <div className="flex items-center gap-1.5 text-gray-300 font-medium pt-1 border-t border-white/10">
            <Car className="w-3.5 h-3.5 text-[var(--color-accent-mint)]" />
            <span>
        ...
        <div className="space-y-2">
          <div className="flex items-start gap-2 bg-[#252525] p-2.5 rounded-xl border border-white/5 text-xs">
            <MapPin className="w-4 h-4 text-[var(--color-accent-mint)] shrink-0 mt-0.5" />
            <div>
          ...
          <div className="flex items-center justify-between bg-[#252525] p-2.5 rounded-xl border border-white/5 text-xs">
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-[var(--color-primary)] hover:bg-[var(--color-primary-container)] text-white font-bold text-[11px] transition-colors flex items-center gap-1 cursor-pointer shrink-0"
              title="Copy Driver Phone"
            >
              {copiedPhone ? (
                <>
                  <Check className="w-3 h-3 text-[var(--color-accent-mint)]" />
                  <span>Copied</span>
                </>
              ) : (
                <>
        ...
        <div className="flex items-center justify-between gap-2 pt-1 border-t border-white/10 text-xs">
          ...
          {onOpenMyBookings && (
            <button
              ...
              className="text-[var(--color-accent-mint)] hover:underline font-bold text-xs flex items-center gap-1 cursor-pointer"
            >
