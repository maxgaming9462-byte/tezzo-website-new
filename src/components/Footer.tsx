...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#f3f3f3] border-t border-[#bdcabd] w-full px-4 sm:px-6 py-8 sm:py-12 mt-auto">
      <div className="max-w-[1120px] mx-auto flex flex-col gap-6 text-[#006a3b]">
        <img
          src={logoUrl}
          alt="Tezzo Logo"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-2">
          <a
            href="#about"
            className="text-xs sm:text-sm font-semibold text-[#3e4a40] hover:text-[#006a3b] transition-colors"
          >
            About us
          </a>
          <a
        ...
        <p className="text-xs font-medium text-[#6e7a6f] mt-4 border-t border-[#eeeeee] pt-4">
